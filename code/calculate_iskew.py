        ...
        if len(yearmonth)>=3:
            for j in range(2,len(yearmonth)):
                ...
                if len(sample)>=20:
                    ...
                    skewdf_row.loc[0,'skew'] = sample['error'].skew()
...
if __name__ == '__main__':
    for part in range(1,21):
        print(part)
        path = 'C:/Users/ASUS/Desktop/groups/temp/groupiskew/eforskew'+str(part)+' .csv'
        skewdf = gen_skew(path)
        outpath = 'C:/Users/ASUS/Desktop/groups/temp/iskew/iskew'+str(part)+' .csv'
